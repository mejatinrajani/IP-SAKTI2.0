...
export default function HeroSection() {
  ...
  return (
    <section className="relative bg-white overflow-hidden">
      ...
      <div className="absolute inset-y-0 right-0 w-1/2 opacity-30 pointer-events-none"
      ...
      <div className="relative max-w-7xl mx-auto px-6 py-24 lg:py-32 grid lg:grid-cols-2 gap-20 items-center">
        ...
        <motion.div variants={container} initial="hidden" animate="visible">
          <motion.div variants={item} className="flex items-center gap-3 mb-7">
            <span className="inline-block text-[10px] font-bold tracking-[0.25em] uppercase text-saffron-600 border border-saffron-300 bg-saffron-50 px-3 py-1.5">
              Ministry of Ayush · Regulatory Intelligence
            </span>
          ...
          <motion.h1
            variants={item}
            className="text-[2.6rem] lg:text-[3.2rem] font-bold text-navy-900 leading-[1.12] mb-7 tracking-tight text-balance"
          >
            From Ayurvedic formulation to regulatory clarity — in one conversation.
          </motion.h1>

          <motion.div variants={item} className="w-16 h-0.5 bg-saffron-400 mb-7" />

          <motion.p variants={item} className="text-lg text-gray-500 leading-relaxed mb-10 max-w-lg">
            IP-SAKTI 2.0 is an AI-powered intelligence platform that evaluates your formulation across 6 regulatory dimensions — statutory classification, IPR, traditional knowledge, biodiversity, evidence, and multilingual reporting — delivering a complete regulatory dossier in under 60 seconds. Free for India's Ayurvedic innovation ecosystem.
          </motion.p>
